...
#define CORNER_RADIIUS 7.0

- (CGFloat)cornerScaleFactor {return self.bounds.size.width / CORNER_FONT_STANDARD_HEIGHT;}
- (CGFloat)cornerRadius { return CORNER_RADIIUS * [self cornerScaleFactor]; }
